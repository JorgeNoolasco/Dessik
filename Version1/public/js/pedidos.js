import {apiRequest, setupSession, element, money, message} from './api.js';
...
async function loadOrders() {
  ...
  message();
  try {
    const orders = await apiRequest('/pedidos', {auth: true});
  ...
  finally { reload.disabled = false; list.setAttribute('aria-busy', 'false'); }
}
